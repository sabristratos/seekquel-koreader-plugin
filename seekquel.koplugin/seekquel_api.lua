...
local UPLOAD_BLOCK_TIMEOUT = 8
local UPLOAD_TOTAL_TIMEOUT = 15
...
function Api:pushProgress(digest, progress, percentage, covered, device, metadata, timeout, chapter, chapter_count)
